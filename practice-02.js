...
//한 주 동안(체크인 시간 arr1, 체크아웃 시간 arr2 의 배열의 길이는 7)이고 공부한 시간을 구하는 함수!
//arr1과 arr2의 배열의 길이는 같으므로 둘 중 하나를 넣어 반복문 돌리기
//체크아웃을 할 때 익일시간은 24+a로 계산한다는 조건과 새벽 5시가 넘어가 체크아웃을 
//하게 되면 자동으로 체크아웃을 21시로 처리해야하므로  24 + 5 =29 보다 작거나 같아야함
